...
df_2022_daily = df.groupby('date').agg({
    'msl': 'mean',
    'u10': 'mean',
    'v10': 'mean',
    'u100': 'mean',
...
X = df_daily[['msl', 'u10', 'v10', 'u100', 'v100', 'wind_speed_10m', 'wind_speed_100m']]
y = df_daily['power_output']

# Split the data into train and test sets
X_train, X_test, y_train, y_test = X, df_2022_daily[['msl', 'u10', 'v10', 'u100', 'v100', 'wind_speed_10m', 'wind_speed_100m']], y, df_2022_daily['power_output']
...
for i in tqdm(range(test_index, len(X_test))):
    ...
    predicted_power, kde_vals = predict_with_kde(knn, single_test_point, df_daily)
    ...
    print(f"Date: {df_daily.loc[X_test.index[test_index], 'date']}")
